...
export const metadata: Metadata = {
  ...
  description: "Portfolio d'Evan Gery, web designer et développeur passionné. Création de sites web modernes, applications React/Next.js, React Native et solutions sur-mesure.",
  keywords: [
    "web designer",
    "développeur web",
    // "freelance",
  ...
  authors: [{ name: "Evan Gery", url: "https://evan-g.com" }],
  creator: "Evan Gery",
  publisher: "Evan Gery",
  formatDetection: {
    email: false,
  ...
  openGraph: {
    ...
    description: "Portfolio d'Evan Gery, web designer et développeur passionné. Création de sites web modernes et sur-mesure.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Evan Gery - Web Designer & Developer Portfolio",
      },
    ],
    type: "website",
    locale: "fr_FR",
